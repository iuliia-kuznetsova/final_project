'''
    ...
    Output:
    - data_preprocessed.parquet - Data file after raw data preprocessing and feature engineering
...
def engineer_features( 
    ...
    '''
        ...
        Strategy:
        - Add lag features (3, 6 months)
        - Add product interactions features
        - Add number of products change features
    '''
